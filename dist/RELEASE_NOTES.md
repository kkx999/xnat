...
- Panel v1.4.0 不引入破坏性数据库变更；Mobile API 继续保持 v1，Web Session + CSRF 与购买链路保持兼容
- Host Agent v1.1.1 / Agent API v1 核心协议保持不变；Host 更新用于同步本 Release 的 CLI、预检和诊断能力
- 正式支持 v1.3.3 → v1.4.0，并继续允许 v1.3.2 直接使用 additive migration 路径升级
